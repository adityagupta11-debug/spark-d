...
export default function ProfilePage({ user, userProfile }: ProfilePageProps) {
  ...
  const interests = userProfile?.interests || ['College Sports', 'Study Groups', 'Campus Life'];
      ...
      <div className="px-4 py-6">
        ...
        <div className="bg-gray-900 rounded-2xl p-6 mb-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            {userProfile?.bio || "Tell other students about yourself! What do you love about college? What are you looking for?"}
          </p>
        </div>
